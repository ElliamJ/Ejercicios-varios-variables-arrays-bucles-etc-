package com.example.programas_asig
...
import com.example.programas_asig.ui.theme.Programas_AsigTheme
            ...
            Ejemplo1()
             Ejemplo2()
              Ejemplo3()
               Ejemplo4()
                Ejemplo5(number = 10)
                 Ejemplo6(month = 3, objetivoCualquiera = 5 )
                  Ejemplo7()
                   Ejemplo8()
...
//Ejemplo #1. Declaracion de variables, constantes y concatenacion
fun Ejemplo1(){
...
//Ejemplo #2. Operaciones aritmeticas y convesion de tipos (Cast)
fun Ejemplo2(){
    val numero1:Int = 20
...
//Ejemplo #3. Manejo de array y listas (Inmutable y Mutable) con filtro
fun Ejemplo3(){
...
//Ejemplo #4. Funciones con parametros de entrada y salida
fun Ejemplo4() {
    MostrarDatosUsuario("Elliam","23")
    FormatearNombre("Elliam")
...
//Ejemplo #5. Estructuras De Control Condicional(if-else anidados)
fun Ejemplo5(number: Int){
...
//Ejempo #6.Control de flujo avanzado con la estructura when
fun Ejemplo6 (month: Int, objetivoCualquiera: Any){
...
//================================================================================
//Ejemplo #7. EstructurasIterativas(Bucle for y do while)
fun Ejemplo7(){
...
//Ejemplo #8. Manejo Seguro de Nulos(null safety y Operador Elvis)
fun Ejemplo8(){
...
//Ejemplo #9. Clase de objetos, data clases y herencia
